...
export function normaliseDeal(d, fieldMap, wonOrgNames = new Set()) {
  ...
  return {
    ...
    firstContactDate: calcFirstEntryDate(d, FIRST_CONTACT_STAGE_ID),
    receivedDate: calcFirstEntryDate(d, RECEIVED_STAGE_ID),
    roofingWorksOnSite: d['90c55b79c62d6d9b63ab0a0172ff7c2032b038be'] || null,
    everIn1stContact: (d.stay_in_pipeline_stages?.order_of_stages || []).includes(FIRST_CONTACT_STAGE_ID),
  }
}
